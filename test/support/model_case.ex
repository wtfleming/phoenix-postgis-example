defmodule OceanShipLogbooks.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import OceanShipLogbooks.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&OceanShipLogbooks.ErrorHelpers.translate_error/1)
